...
**AI Tools:** Claude Code (daily driver), Cursor, Antigravity (Gemini)
...
When using Antigravity (Gemini), connect these MCP servers for the full agentic workflow:
...
- `GEMINI.md` (this file) = the operating system — always-on project context
...
```
Ask Gemini -> It reads GEMINI.md -> Loads relevant Skill ->
